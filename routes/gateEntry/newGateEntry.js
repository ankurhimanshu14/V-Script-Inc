...
module.exports = {
    ...
    fetchNewItemData: (req, res, next) => {
        req._newItem = new ITEM_MODEL({
            ...
            [ITEM_FIELDS.ITEM_CODE]: req.body.itemCode,
            [ITEM_FIELDS.ITEM_DESCRIPTION]: req.body.itemDescription,
            [ITEM_FIELDS.ITEM_HEADER]: req.body.itemHeader,
            [ITEM_FIELDS.PO_NO]: req.body.poNo,
            [ITEM_FIELDS.HSN_CODE]: req.body.hsnCode,
            [ITEM_FIELDS.QUANTITY]:req.body.quantity,
            [ITEM_FIELDS.UOM]: req.body.uom,
            ...
            [ITEM_FIELDS.GR_NO]: req.body.grNo,
        ...
        if(_decrypt) {
            req._newItem.createdBy = _decrypt.userId;
            req._newItem.modifiedBy = _decrypt.userId;
            next();
        }
    },
