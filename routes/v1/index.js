...
const { pendingApprovals, registration: steelRegistration, inventory: steelInventory, releaseToCutting: releaseSteel } = require('../rmStore');
...
//RM_STORE
router.get('/private/steels/pendingApprovals', auth, pendingApprovals.populateItems, pendingApprovals.response);
